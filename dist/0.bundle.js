...
Component.options.__file = "/Users/mac-fx/wbg/mycat/app/views/Activity.vue"
...
// module
exports.push([module.i, ".box {\n    margin-top: 0!important;\n}\n.footer{\n    width: 100%;\n}\n.active-tit{\n    width: 100%;\n    height: 5rem;;\n    background: #ccc;\n    color:#fff;\n    font-size: 1.5rem;\n    line-height: 5rem;\n}\n.active-box {\n    overflow: hidden;\n    position: relative;\n    width: 100%;\n    height: auto;\n    padding-bottom: 1rem;\n}\n.active-box li { \n    overflow: hidden;\n    position: absolute;\n    width: 48%;\n    margin-left: 1%;\n    border-radius: 8px;\n    box-shadow: 1px 2px 3px rgba(64, 64, 64, 0.52);\n}\n.active-box li img {\n    display: block;\n    width: 100%;\n    height: auto;\n}\n.showanim{\n    animation:maxl 60s linear infinite;\n\t-webkit-animation:maxl 60s linear infinite;\n}\n@keyframes maxl {\n    0%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n    20%{\n        transform: scale(1.05);\n        -webkit-transform: scale(1.05);\n    }\n    40%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n    60%{\n        transform: scale(.95);\n        -webkit-transform: scale(.95);\n    }\n    80%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n    100%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n}\n@-webkit-keyframes maxl {\n    0%{\n        transform: scale(1.1);\n        -webkit-transform: scale(1.1);\n    }\n    20%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n    40%{\n        transform: scale(.9);\n        -webkit-transform: scale(.9);\n    }\n    60%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n    80%{\n        transform: scale(1.1);\n        -webkit-transform: scale(1.1);\n    }\n    100%{\n        transform: scale(1);\n        -webkit-transform: scale(1);\n    }\n}\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!./loadimg.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!./loadimg.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "active-tit"
  }, [_vm._v("活动列表")]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-6c988ef1", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(59)("32594bd2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
